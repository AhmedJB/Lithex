...
export default function Header(){
    ...
    <section>
        ...
        <aside>
        <a className="referral-button" href="profile/referrals.html" style={{color: '#4A5056'}}><i className="fa fa-gift fs-xl2" /></a><a className="NotificationsButton" aria-expanded="false" style={{color: '#777d84'}}><i className="fa fa-bell" /></a><a className="MenuHelp" aria-expanded="false" style={{color: '#777d84'}}><i className="fa fa-question-circle" /></a><a onClick={() => logout(setUser)} className="MenuAccount" aria-expanded="false"><i className="fa fa-user" /><i className="fa fa-angle-down" /></a>
        </aside>
    </section>
    </header>
